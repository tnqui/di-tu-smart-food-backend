package com.tranngocqui.ditusmartfoodbackend.service.application.jwt;
    ...
    public String generateRefreshToken(User user) {
        try {
            ...
            Jwt jwt = Jwt.builder()
                    ...
                    .revoked(false)
                    .expirationDate(jwtClaimsSet.getExpirationTime().toInstant())
                    .issuedDate(jwtClaimsSet.getIssueTime().toInstant())
