//package com.tranngocqui.ditusmartfoodbackend.tempservice.application.auth;
//
...
//import com.tranngocqui.ditusmartfoodbackend.dto.admin.auth.request.IntrospectRequest;
...
//import com.tranngocqui.ditusmartfoodbackend.dto.admin.auth.request.TwoFALoginRequest;
...
//import com.tranngocqui.ditusmartfoodbackend.tempservice.application.jwt.JwtService;
//import com.tranngocqui.ditusmartfoodbackend.tempservice.application.user.UserService;
...
//        User user = userService.getByEmail(authRequest.getIdentifier())
//                .or(() -> userService.getByPhone(authRequest.getIdentifier()))
//                .orElseThrow(() -> new AppException(ErrorCode.INVALID_USERNAME_OR_PASSWORD));
//
//        Set<RoleEnum> roles = user.getRoles().stream().map(Role::getName).collect(Collectors.toSet());
//
...
//        }
//
//        String userId = jwtService.getUserIdFromJwt(setup2FaToken);
//
//        if (userId == null) {
//            throw new AppException(ErrorCode.INVALID_TOKEN);
//        }
//
//        User user = userDomainService.getByIdOrThrow(userId);
//
...
//        }
//
//        String userId = jwtService.getUserIdFromJwt(twoFactorSetupToken);
...
//        }
//
//        String userId = jwtService.getUserIdFromJwt(preLoginToken);
//
//        if (userId == null) {
//            throw new AppException(ErrorCode.INVALID_TOKEN);
//        }
